// src/components/landing/LandmarkDome.tsx
'use client';
...
// ─── Wrapper with landmark images ──────────────────────────────────────────────

const LANDMARK_IMAGES = [
    { src: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=600&q=80', alt: 'Eiffel Tower, Paris' },
    { src: 'https://images.unsplash.com/photo-1564507592333-c60657eea523?w=600&q=80', alt: 'Taj Mahal, India' },
    { src: 'https://images.unsplash.com/photo-1508804185872-d7badad00f7d?w=600&q=80', alt: 'Colosseum, Rome' },
    { src: 'https://images.unsplash.com/photo-1539650116574-8efeb43e2750?w=600&q=80', alt: 'Great Wall of China' },
    { src: 'https://images.unsplash.com/photo-1526392060635-9d6019884377?w=600&q=80', alt: 'Machu Picchu, Peru' },
    { src: 'https://images.unsplash.com/photo-1568322445389-f64ac2515020?w=600&q=80', alt: 'Pyramids of Giza' },
    { src: 'https://images.unsplash.com/photo-1490806843957-31f4c9a91c65?w=600&q=80', alt: 'Mount Fuji, Japan' },
    { src: 'https://images.unsplash.com/photo-1541432901042-2d8bd64b4a9b?w=600&q=80', alt: 'Hagia Sophia, Istanbul' },
    { src: 'https://images.unsplash.com/photo-1524492412937-b28074a5d7da?w=600&q=80', alt: 'Big Ben, London' },
    { src: 'https://images.unsplash.com/photo-1485738422979-f5c462d49f04?w=600&q=80', alt: 'Statue of Liberty, New York' },
    { src: 'https://images.unsplash.com/photo-1506973035872-a4ec16b8e8d9?w=600&q=80', alt: 'Sydney Opera House' },
    { src: 'https://images.unsplash.com/photo-1483729558449-99ef09a8c325?w=600&q=80', alt: 'Christ the Redeemer, Rio' },
    { src: 'https://images.unsplash.com/photo-1596402184320-417e7178b2cd?w=600&q=80', alt: 'Cappadocia, Turkey' },
    { src: 'https://images.unsplash.com/photo-1548013146-72479768bada?w=600&q=80', alt: 'Angkor Wat, Cambodia' },
    { src: 'https://images.unsplash.com/photo-1555881400-74d7acaacd8b?w=600&q=80', alt: 'Sagrada Familia, Barcelona' },
    { src: 'https://images.unsplash.com/photo-1549144511-f099e773c147?w=600&q=80', alt: 'Petra, Jordan' },
    { src: 'https://images.unsplash.com/photo-1512446816042-444d641267d4?w=600&q=80', alt: 'Neuschwanstein Castle, Germany' },
    { src: 'https://images.unsplash.com/photo-1576485375217-d6a95e34d043?w=600&q=80', alt: 'Santorini, Greece' },
    { src: 'https://images.unsplash.com/photo-1513581166391-887a96ddeafd?w=600&q=80', alt: 'Burj Khalifa, Dubai' },
    { src: 'https://images.unsplash.com/photo-1551632811-561732d1e306?w=600&q=80', alt: 'Acropolis, Athens' },
    { src: 'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=600&q=80', alt: 'Northern Lights, Iceland' },
];
